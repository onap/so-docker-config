...
function pull_docker_images() {
    ...
    # get images
    $DOCKER_CMD pull $NEXUS_DOCKER_REPO_MSO/onap/so:$MSO_DOCKER_IMAGE_VERSION
    $DOCKER_CMD tag $NEXUS_DOCKER_REPO_MSO/onap/so:$MSO_DOCKER_IMAGE_VERSION onap/so:latest
    $DOCKER_CMD rmi $NEXUS_DOCKER_REPO_MSO/onap/so:$MSO_DOCKER_IMAGE_VERSION
